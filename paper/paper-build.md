...
![**Figure 7.** The progression over time: rule stock (top), dispatch burden with the surviving task-grain windows marked (middle), and throughput (bottom).](figures/fig7-progression.png){width=100%}
