...
### 4.5 The system destroyed its own history at the moment of ignition

The study's central gap has a precise date and, remarkably, a name. The task ledger for January–early July was destroyed on **July 4, 2026**—the same day the agency automation-and-gate block switched on—when the coordination graph was recreated wholesale as part of what the system's own recovery tag calls the **"overengineered-cutover."** The ignition event and the destruction of the record are the same event: the system erased its own history at the moment of maximal overengineering. From July 4, the retention discipline this paper argues for began to exist in practice: on August 5 the damaged graph was **quarantined atomically**—relocated in full, with a do-not-run note and an evidence-preserving tag—saving 253 archived tasks (July 4–25) and the complete live graph of July 26–August 5 (824 tasks with audit chains), together with attempts, completion records, finalization journals, and the ignition week's complete configuration-backup series. The current ledger begins August 8.

Two lessons, sharper than an earlier draft of this section had them. First, a system that records everything but guarantees retention of nothing produces forensic records with a shaped absence—and here the absence was carved by the very dynamic under study, not by routine compaction: **the cascade destroyed the record of the cascade.** Second, the organization developed the correct reflex under pressure: quarantine-and-preserve emerged as practice on August 5, a month before the operator's own teardown. Retention of the audit trail must still be a first-class constraint—the July 4 cutover shows it cannot be left to emerge—but the August 5 quarantine shows the machinery can learn it. Configuration history at the user layer (`~/.wg`), which survived both events, dated the ignition week when the project ledger could not; forensic completeness requires inventorying state at every layer.
